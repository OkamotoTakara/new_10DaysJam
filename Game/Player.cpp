...
void Player::Draw(DrawingByRasterize& arg_rasterize, Raytracing::BlasVector& arg_blasVec)
{
	...
	ImGui::DragFloat("BASE_POS_X", &UI_BASE_POS.x, 1.0f);
	ImGui::DragFloat("BASE_POS_Y", &UI_BASE_POS.y, 1.0f);
	ImGui::DragFloat("BASE_POS_SCALE", &UI_BASE_SCALE.x, 0.1f);
	ImGui::DragFloat("BASE_POS_SCALE", &UI_BASE_SCALE.y, 0.1f);
	ImGui::Text(" ");
	ImGui::DragFloat("BAR_POS_X", &UI_HPBAR_POS.x, 1.0f);
	ImGui::DragFloat("BAR_POS_Y", &UI_HPBAR_POS.y, 1.0f);

...
void DrawCallSet::Draw(DrawingByRasterize& arg_rasterize, Raytracing::BlasVector& arg_blasVec, KazMath::Transform3D arg_transform, int arg_instanceID, bool m_isDrawRaytracing)
{

	DrawFunc::DrawModel(m_model, arg_transform);
	m_model.extraBufferArray.back() = m_boneIdentity;
